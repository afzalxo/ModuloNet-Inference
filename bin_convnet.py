...
class BinCNN:
    ...
    def build_convnet(self, in_act):
        ...
        l0 = self.bin_conv2d(in_act, self.model['l0_w'], self.model['l0_b'], padding = 'SAME', name='bin_conv2d_l0')
        ...
        l1 = self.bin_conv2d(l0, self.model['l1_w'], self.model['l1_b'], padding = 'SAME', name='bin_conv2d_l1')
        ...
        l2 = self.bin_conv2d(l1, self.model['l2_w'], self.model['l2_b'], padding = 'SAME', name='bin_conv2d_l2')
        ...
        l3 = self.bin_conv2d(l2, self.model['l3_w'], self.model['l3_b'], padding = 'SAME', name='bin_conv2d_l3')
        ...
        l4 = self.bin_conv2d(l3, self.model['l4_w'], self.model['l4_b'], padding = 'SAME', name='bin_conv2d_l4')
        ...
        l5 = self.bin_conv2d(l4, self.model['l5_w'], self.model['l5_b'], padding = 'SAME', name='bin_conv2d_l5')
        ...
        l6 = self.bin_dense_layer(l5, self.model['l6_w'], self.model['l6_b'], name='dense0')
        ...
        l7 = self.bin_dense_layer(l6, self.model['l7_w'], self.model['l7_b'], name='dense1')
